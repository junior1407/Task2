//'<div class="popover" role="tooltip" style="width: 400px; max-width: 400px">\n\
//          <img src="/lib/svg/toti.tour.svg" style="float: left; margin: 0px 10px -1px 10px; height:90px"/>\n\
//          <div class="arrow"></div>\n\
//          <div class="popover-content dark-blue" style="font-style: italic"></div>\n\
//          <div class="popover-navigation">\n\
//            <div class="btn-group">\n\
//              <button class="btn btn-sm btn-default" data-role="prev">&laquo; Anterior</button>\n\
...
//            </div>\n\
//            <button class="btn btn-sm btn-default" data-role="end">Fim do tour</button>\n\
//          </div>\n\
//        </div>',
  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        basePath: '',
        template:
        '<div class="popover" role="tooltip" style="max-width: 440px">' +
          // <div class="col-xs-3" style="position: absolute; bottom: 0">
            // <img src="/lib/svg/toti.tour.svg" style="height: 84px">\n\
          // </div>\n\
          '<div class="col-xs-12">\n\
            <div class="popover-content dark-blue" style="font-style: italic"></div>\n\
            <div class="popover-navigation">\n\
    ...
    Tour.prototype._center = function($tip) {
      ...
      var width = (window.innerWidth > 600) ? '600' : window.innerWidth - 10;
      return $tip.css('top', $(window).outerHeight() / 2 - $tip.outerHeight() / 2).css('width',`${width}px`).css('left',`calc(50% - ${width/2}px)`);
    };
